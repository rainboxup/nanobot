...
class SubagentManager:
    ...
    async def _run_subagent(
        ...
        try:
            ...
            tools.register(ReadFileTool(allowed_dir=allowed_dir, max_read_bytes=fs.max_read_bytes))
            tools.register(
                WriteFileTool(
            ...
            tools.register(ListDirTool(allowed_dir=allowed_dir, max_entries=fs.max_list_entries))
            tools.register(
                ExecTool(
            ...
            tools.register(WebSearchTool(api_key=api_key, max_results=search_cfg.max_results))
