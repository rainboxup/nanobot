...
def resolve_audit_log_path(
    *,
    ...
    if config_path is not None:
        return Path(config_path).expanduser().parent / "web_audit.log"
    if workspace_path is not None:
        return Path(workspace_path).expanduser().parent / "web_audit.log"
    return Path.home() / ".nanobot" / "web_audit.log"
